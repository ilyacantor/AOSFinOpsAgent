 ...
 * 
 * Simplified architecture for single database operation.
 * Removed all multi-tenant complexity for maintainability.
 */
...
export const recommendations = pgTable("recommendations", {
  ...
  aiHistoryIdx: index("idx_recommendations_ai_history").on(table.aiModeHistoryId),
}));
